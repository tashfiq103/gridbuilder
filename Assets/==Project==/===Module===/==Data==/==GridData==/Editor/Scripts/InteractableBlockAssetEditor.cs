namespace Project.Data.Grid
{
    ...
    [CustomEditor(typeof(InteractableBlockAsset))]
    public class InteractableBlockAssetEditor : Editor
    {
        #region Private Variables

        private InteractableBlockAsset _reference;
        ...
        {
            _reference = (InteractableBlockAsset)target;
